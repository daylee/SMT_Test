...
class BatteryConstraints(Component):
    ...
    def __init__(self, n=2):
        ...
        self.add_output('ConCh', val=0.0, desc='Constraint on charging rate', units='A')
        self.add_output('ConDs', val=0.0, desc='Constraint on discharging rate', units='A')
        self.add_output('ConS0', val=0.0, desc='Constraint on minimum state of charge', units='unitless')
        self.add_output('ConS1', val=0.0, desc='Constraint on maximum state of charge', units='unitless')
