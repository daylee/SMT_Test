...
class Orbit_Initial(Component):
    ...
    def __init__(self):
        ...
        self.add_param('altPerigee', val=500.0, desc='Altitude of Perigee', units='km')
        self.add_param('altApogee', val=500.0, desc='Altitude of Apogee', units='km')
        self.add_param('RAAN', val=66.279, desc='RAAN', units='deg')
        self.add_param('Inc', val=82.072, desc='Inclination', units='deg')
        self.add_param('argPerigee', val=0, desc='Argument of Perigee', units='deg')
        self.add_param('trueAnomaly', val=337.987, desc='True Anomaly', units='deg')
