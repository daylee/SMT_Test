...
class Comm_AntRotation(Component):
    ...
    def __init__(self, n):
        ...
        self.add_param('antAngle', val=0, desc='Antenna Angle', units='rad')
...
class Comm_GSposEarth(Component):
    ...
    def __init__(self, n):
        ...
        self.add_param('lon', val=0.0, desc='Longitude of ground station in Earth-fixed frame', units='rad')
        self.add_param('lat', val=0.0, desc='Latitude of ground station in Earth-fixed frame', units='rad')
        self.add_param('alt', val=0.0, desc='Altitude of ground station in Earth-fixed frame', units='rad')
